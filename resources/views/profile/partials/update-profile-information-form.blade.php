<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        {{-- TAMBAHKAN BLOK INI UNTUK NOMOR TELEPON --}}
        <div>
        ...
        <div class="flex items-center gap-4">
            <x-primary-button
                class="bg-orange-500 hover:bg-orange-600 focus:bg-orange-700 active:bg-orange-800 focus:ring-orange-500">{{ __('Simpan') }}</x-primary-button>

            {{-- Notifikasi 'Saved.' dari Breeze akan muncul di sini jika menggunakan komponennya --}}
            {{-- Jika Anda ingin SweetAlert, Anda perlu mengubah cara ProfileController mengirim status --}}
